const t3_hint_password = "Mot de passe"; //mot de passe
const t3_lbl_remember = "Se souvenir"; // se souvenir
const t3_lbl_adresse = "Adresse"; //adresse
const t3_hint_Email = "E-mail"; //email
const t3_lbl_specialite = "Spécialité"; //spécialité
const t3_lbl_genre = "Genre"; //genre
const t3_lbl_telephone = "00000"; //telephone
const t3_hint_hopcli = "Hôpital / Clinique"; //hôpital ou Clinique
const t3_lbl_sign_in = "Se connecter";
const t3_lbl_sign_in_link = "Se connecter";
const t3_lbl_forgot_password = "Mot de passe oublié?"; //mot de passe oublié
const t3_lbl_welcome = "Ilyan Medical";
const t3_lbl_back = "Bienvenue!";
const t3_lbl_don_t_have_account = "Vous n\'avez pas de compte?";
const t3_lbl_sign_up = "Inscription";
const t3_lbl_sign_up_link = "Inscription";
const t3_lbl_create_account = "Inscrivez Vous!";
const t3_lbl_recipe_for_happiness = "MEDECIN";
const t3_hint_confirm_password = "Confirm Password"; //confirmer mot de passe
const t3_lbl_already_have_account = "Avez-vous déjà un compte ?";
...
const t3_user_nom = "Nom"; //nom
const t3_user_prenom = "Prénom";
const t3_user_email = "JohnDoe@gmail.com"; //email
...
const t3_lbl_name = "John Doe"; //nom
const t3_lbl_email = "John@gmail.com"; //email
