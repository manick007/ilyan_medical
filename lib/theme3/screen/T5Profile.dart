...
import 'package:ilyan_medical/theme3/screen/editprofile.dart';
...
class T5ProfileState extends State<T5Profile> {
  ...
  var nameList = ['23', '30', '48', 'Null'];
  var titre = ['Patients', 'En cours', 'Terminé'];
    ...
    return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            text(titre[pos],
                fontSize: 12.0,
                textColor: (pos == 0 || pos == 2 ) ? Color(0xff7cd955) : Colors.red,
              ...
              children: <Widget>[
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: ClipRRect(
                      child: Image.asset(t3_ic_profile2,
                ...
                children: <Widget>[
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              child: CircleAvatar(
                                ...
                                backgroundImage: AssetImage(t3_ic_profile1),
                          ...
                          children: <Widget>[gridItem(0), gridItem(1),gridItem(2)],
                        ),
                          ],
                        ),
                      ),
                  ...
                  Container(
                    ...
                    forceWebView: true, enableJavaScript: true);*/
                          ...
                          leading: Image.asset(t3_ic_profile3,
                              height: 24, width: 24),
                        ),
                    ...
                    forceWebView: true, enableJavaScript: true);*/
                          ...
                          leading: Image.asset(t3_ic_profile5,
                              height: 24, width: 24),
                        ),
                        Divider(height: 1, thickness: 10),
                        settingItems(
                    ...
                    forceWebView: true, enableJavaScript: true);*/
                          ...
                          leading: Image.asset(t3_ic_profile8,
                              height: 24, width: 24),
                        ),
                        Divider(height: 1, thickness: 10),
                        settingItems(
                    ...
                    forceWebView: true, enableJavaScript: true);*/
                          ...
                          leading: Image.asset(t3_ic_profile7,
                              height: 24, width: 24),
                        ),
                      ],
                    ),
  ...
  void _checkIfLoggedIn() async {
    ...
    var tokenpre = localStorage.getString('prenoms');
    var tokenad = localStorage.getString('adresse');
    var tokenem = localStorage.getString('email');
    var tokentel = localStorage.getString('telephone');
    var tokentid = localStorage.getString('id_medecin');
    var tokentinum = localStorage.getString('numero_rtps');
    print(tokentid);
    if (token != null) {
      setState(() {
        name = token;
        ...
        email = tokenem;
        telephone = tokentel;
        //nameList = [hopital, adresse, telephone, email];
        id = tokentid;
      });
    }
  }

  Widget editModal(BuildContext context) {
    //SingleChildScrollView(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: AppButton(
              textContent:
                  _isLoading ? 'En cours...' : 'Mise à jour', //bouton connexion
              onPressed: () {
                ...
                var data = {
                  ...
                  'prenoms': firtNameController.text,
  ...
  void _update(data) async {
    ...
    var res = await Network().authData(data, '/update.php');
    var body = json.decode(res.body);

    if (body == 'good') {
      print('is data good $body');
      SharedPreferences localStorage = await SharedPreferences.getInstance();
      localStorage.setString('name', data['nom']);
      localStorage.setString('prenoms', data['prenoms']);
      localStorage.setString('adresse', data['adresse']);
      localStorage.setString('email', data['email']);
      localStorage.setString('telephone', data['telephone']);
      setState(() {
        name = lastNameController.text;
        prenom = firtNameController.text;
        adresse = adresseController.text;
        telephone = telephoneController.text;
        //nameList = [hopital, adresse, telephone, email];
      });
